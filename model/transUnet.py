...
vit_encoder = (
    vit_encoder.to("cuda") if torch.cuda.is_available() else vit_encoder.to("cpu")
)
...
class TransUnet_b5(nn.Module):
    def __init__(self):
        ...
        self.backbone = _models.efficientnet_b5(
        ...
        self.res_conv = nn.Sequential(nn.Conv2d(16, 16, 3, 1, 1), nn.ReLU(inplace=True))
